...
def send_email_notification(to_emails, project_name):
            ...
            body = f"""
                ...
                You have been added as an authorized user to the project: {project_name}.
                
                This is an automated message from Craigslist Safebot. 
                Please do not reply to this email as responses are not monitored.
            
                If you have any questions, contact the admin directly.
